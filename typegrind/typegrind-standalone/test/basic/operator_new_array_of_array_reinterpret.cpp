...
int main(void) {
    // CHECK: int** pT = reinterpret_cast<int**>(TYPEGRIND_LOG_OP_NEW_ARRAY("{{.*}}/clang-typegrind/test/basic/operator_new_array_of_array_reinterpret.cpp:8", "int *", "int *", (::operator new[](4)), sizeof(int *), 4));
